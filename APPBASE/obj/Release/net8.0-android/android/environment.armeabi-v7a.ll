...
@dso_cache = dso_local local_unnamed_addr global [696 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1405043152, ; hash 0x53bf41d0, from name: libaot-APPBASE
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1997213994, ; hash 0x770b112a, from name: aot-APPBASE
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-APPBASE.dll.so
		ptr null; void* handle (0x0)
	}, ; 313
	...
	%struct.DSOCacheEntry {
		i64 3603964784, ; hash 0xd6d02370, from name: aot-APPBASE.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-APPBASE.dll.so
		ptr null; void* handle (0x0)
	}, ; 590
	...
	%struct.DSOCacheEntry {
		i64 3695742728, ; hash 0xdc488f08, from name: APPBASE.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-APPBASE.dll.so
		ptr null; void* handle (0x0)
	}, ; 609
	...
	%struct.DSOCacheEntry {
		i64 3796307295, ; hash 0xe2470d5f, from name: libaot-APPBASE.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-APPBASE.dll.so
		ptr null; void* handle (0x0)
	}, ; 621
	...
	%struct.DSOCacheEntry {
		i64 4266170833, ; hash 0xfe4899d1, from name: APPBASE
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-APPBASE.dll.so
		ptr null; void* handle (0x0)
	}, ; 689
